        ...
        <div class="table-responsive-xxl m-2">
            ...
            <table class="table ">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <form action="procesar_editar_a.php" method="POST">
                          
                            <td><input type="text" value="<?php echo $mostar['nombre_proveedor'] ?>" name="nom"></td> 
                             <td><input type="text" value="<?php echo $mostar['id_proveedor'] ?> " name="id" readonly> </td>
