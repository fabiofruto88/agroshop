...
while ($mostar = mysqli_fetch_array($resultado)) {
  $id_agg= $mostar['id_cliente'];
  $nom_cli=$mostar['Nombre'];
    ...
    <div class="container mt-3 bg-light text-center rounded ">
        ...
        <div class="row">
            ...
            <div class="col-md-6 order-md-2 my-3">
                ...
                <a href="https://api.whatsapp.com/send/?phone=57,<?php echo $tel_prov ?>&text=Hola%2C+soy+el+cliente+<?php echo $nom_cli ?>+con+la+identificación+<?php echo $id_agg ?>+te+contacto+por+la+p%C3%A1gina+web+detucampo.com+quisiera+realizar+la+compra+de+este+producto+con+referencia+producto+<?php echo $ref_pr ?>&type=phone_number&app_absent=0" class="btn btn-success btn-md">contactar (whastapp)</a>
    <a href="report_cli.php" class="btn btn-primary btn-md">regresar</a> 
            </div>
        </div>
