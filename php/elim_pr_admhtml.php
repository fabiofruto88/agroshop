...
<body style="background-color: rgb(148, 96, 17 );">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active me" href="admn_control_usuarios.html" style="color: white;">reporte de usuarios</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="col-xxl-10 col-xl-10 col-lg-11 col-md-11 col-sm-11 col-11 text-center mx-auto p-3 mt-5 rounded bg-light">
        <form class="row g-3 m-1 p-1" method="post" action="../php/elim_pro_adm.php" >
